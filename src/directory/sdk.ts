import { W3blockDirectorySDKOptions } from '../interfaces';
...
export class W3blockDirectorySDK {
  public api: Api<ApiSecurityDataType>;
  protected authToken: string | null = null;
  protected options: W3blockDirectorySDKOptions;

  protected defaultOptions: Partial<W3blockDirectorySDKOptions> = {
    baseURL: process.env.DIRECTORY_API_BASE_URL || 'https://diretory.w3block.io',
  };

  constructor(options: W3blockDirectorySDKOptions) {
    this.options = Object.assign({}, this.defaultOptions, options);

    // noinspection SuspiciousTypeOfGuard
    if (!(this.options.idSdk instanceof W3blockIdSDK)) {
      throw new Error(`You most inform a valid instance of W3BLockIdSDK to use Directory SDK`);
    }
